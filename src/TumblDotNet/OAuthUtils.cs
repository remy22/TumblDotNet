...
namespace TumblDotNet
{
  ...
  {
    [EnumStringValue("HMAC-SHA1")]
    HMACSHA1,
    [EnumStringValue("RSA-SHA1")]
    RSASHA1,
    [EnumStringValue("PLAINTEXT")]
    PLAINTEXT
  }

  internal enum OAuthProtocolParameter
  {
    [EnumStringValue("oauth_consumer_key")]
    ConsumerKey,
    [EnumStringValue("oauth_signature_method")]
    SignatureMethod,
    [EnumStringValue("oauth_signature")]
    Signature,
    [EnumStringValue("oauth_timestamp")]
    Timestamp,
    [EnumStringValue("oauth_nonce")]
    Nounce,
    [EnumStringValue("oauth_version")]
    Version,
    [EnumStringValue("oauth_callback")]
    Callback,
    [EnumStringValue("oauth_verifier")]
    Verifier,
    [EnumStringValue("oauth_token")]
    Token,
    [EnumStringValue("oauth_token_secret")]
    TokenSecret
  }
